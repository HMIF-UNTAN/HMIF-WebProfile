<footer class="text-white py-10 bg-[#0F4696]">
    <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
      <div class="flex flex-col md:flex-row justify-between items-start md:items-center space-y-6 md:space-y-0">
        ...
        <div class="md:w-2/3">
          ...
          <div class="flex mt-4 space-x-4 text-xl">
            <a href="https://www.linkedin.com/company/hmif-ft-untan/" 
                target="_blank" 
             ...
             <a href="https://www.instagram.com/hmif_ftuntan?utm_source=ig_web_button_share_sheet&igsh=ZDNlZDc0MzIxNw==" 
                target="_blank" 
                rel="noopener noreferrer" 
                class="hover:text-blue-400">
      ...
      <p class="text-center text-sm">&copy; HMIF {{ date('Y') }}. All rights reserved.</p>
    </div>
  </footer>  